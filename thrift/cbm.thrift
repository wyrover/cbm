...
service CbmService {
	...
	//查询基地所有的矿区
	list<string> GetAllMineRegions(1:string baseName),
	//根据矿区反查基地
	string GetBaseByRegion(1:string regionName),
	//查询示范矿区的虚拟矿井
	Mine GetSampleMine(1:string regionName),
	//查询示范矿区的虚拟煤层
	Coal GetSampleCoal(1:string regionName),
	//查询矿井所有的煤层名称
	list<string> GetCoalNames(1:i32 mine_id),
	//查询矿井所有的煤层id
	list<i32> GetCoalIds(1:i32 mine_id),
	//查询矿井所有的采区
	list<WorkArea> GetWorkAreas(1:i32 mine_id),
	//查询矿井所有的工作面
	list<WorkSurf> GetWorkSurfs(1:i32 mine_id),
	//查询矿井所有的掘进面
	list<DrillingSurf> GetDrillingSurfs(1:i32 mine_id),
	list<i32> GetWorkAreaIds(1:i32 mine_id),
	list<i32> GetWorkSurfIds(1:i32 mine_id),
	list<i32> GetDrillingSurfIds(1:i32 mine_id),
	...
	//掘进面瓦斯涌出量
	void DrillingSurfGasFlow(1:Coal coal, 2:DrillingSurf drilling_surf, 3:Tunnel tunnel),
}
