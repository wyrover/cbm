...
class ARXHELPER_API cruise_log4cplus : public Singleton<cruise_log4cplus>
{
public:
...
extern ARXHELPER_API void log_init( tchar* prop_file, tchar* prefix_log_flie = NULL, tchar* sub_logger_name = NULL );
extern ARXHELPER_API void log_uinit();
