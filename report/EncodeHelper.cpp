...
std::string EncodeHelper::ANSIToUtf8( const std::string& str )
{
    ...
    //unicode --> utf8
    std::string result;
    len = ::WideCharToMultiByte( CP_UTF8, NULL, resultTmp.c_str(), ( int )resultTmp.size(), NULL, 0, NULL, NULL );
    result.assign( len, 0 );
    char* pResult = ( char* )result.data();
    ::WideCharToMultiByte( CP_UTF8, NULL, resultTmp.data(), ( int )str.size(), pResult, len, NULL, NULL );
...
std::string EncodeHelper::Utf8ToANSI( const std::string& str )
{
    ...
    resultTmp.assign( len, 0 );
    wchar_t* p = ( wchar_t* )resultTmp.data();
    ::MultiByteToWideChar( CP_UTF8, NULL, str.data(), ( int )str.size(), p, len );

    //unicode --> ansi
    std::string result;
    len = ::WideCharToMultiByte( CP_ACP, NULL, resultTmp.c_str(), ( int )str.size(), NULL, 0, NULL, NULL );
    result.assign( len, 0 );
    char* pResult = ( char* )result.data();
    ::WideCharToMultiByte( CP_ACP, NULL, resultTmp.data(), ( int )str.size(), pResult, len, NULL, NULL );
...
std::string EncodeHelper::UnicodeToUtf8( const std::wstring& str )
{
    // unicode --> utf8
    std::string result;
    int len = ::WideCharToMultiByte( CP_UTF8, NULL, str.c_str(), ( int )str.size(), NULL, 0, NULL, NULL );
    result.assign( len, 0 );
    char* p = ( char* )result.data();
    ::WideCharToMultiByte( CP_UTF8, NULL, str.data(), ( int )str.size(), p, len, NULL, NULL );
