...
class DEFGE_EXPORT_API DCI : public PointGE
{
public:
...
class DEFGE_EXPORT_API CSDCI : public DCI
{
public:
...
class DEFGE_EXPORT_API WDCI1 : public DCI
{
public:
...
class DEFGE_EXPORT_API WDCI2 : public DCI
{
public:
