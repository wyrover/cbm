...
class DEFGE_EXPORT_API GOP : public PointGE
{
public:
...
// 小型突出点
class DEFGE_EXPORT_API SmallGOP : public GOP {
...
// 中型突出点
class DEFGE_EXPORT_API MidGOP : public GOP {
...
// 大型突出点
class DEFGE_EXPORT_API LargeGOP : public GOP {
...
// 特大型突出点
class DEFGE_EXPORT_API LargerGOP : public GOP {
