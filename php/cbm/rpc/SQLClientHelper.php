...
function GetAccountByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetAccountByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetAccountIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetAccountIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetAdjLayerByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetAdjLayerByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetAdjLayerIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetAdjLayerIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetCoalByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetCoalByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetCoalIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetCoalIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetComplexityByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetComplexityByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetComplexityIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetComplexityIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetDesignDrillingSurfTechnologyByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetDesignDrillingSurfTechnologyByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetDesignDrillingSurfTechnologyIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetDesignDrillingSurfTechnologyIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetDesignGoafTechnologyByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetDesignGoafTechnologyByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetDesignGoafTechnologyIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetDesignGoafTechnologyIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetDesignPoreByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetDesignPoreByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetDesignPoreIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetDesignPoreIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetDesignSiteByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetDesignSiteByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetDesignSiteIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetDesignSiteIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetDesignTechnologyByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetDesignTechnologyByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetDesignTechnologyIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetDesignTechnologyIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetDesignWorkSurfTechnologyByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetDesignWorkSurfTechnologyByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetDesignWorkSurfTechnologyIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetDesignWorkSurfTechnologyIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetDrillingRadiusParamByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetDrillingRadiusParamByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetDrillingRadiusParamIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetDrillingRadiusParamIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetDrillingSurfByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetDrillingSurfByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetDrillingSurfIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetDrillingSurfIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function AddEvalUnit($fname) {
	$ret = -1;
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$ret = $client->AddEvalUnit($fname);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$ret = -1;
	}
...
function UpdateEvalUnit($fname) {
	$ret = false;
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$ret = $client->UpdateEvalUnit($fname);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$ret = false;
	}
...
function GetEvalUnitById($id) {
	$_return = new EvalUnit();
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
...
function GetEvalUnitByForeignKey($fkey, $id) {
	$_return = new EvalUnit();
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
...
function GetEvalUnitIdByForeignKey($fkey, $id) {
	$_return = -1;
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
...
function GetEvalUnitList() {
	$_return = array();
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetEvalUnitList();
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = array();
	}
...
function GetEvalUnitIds() {
	$_return = array();
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetEvalUnitIds();
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = array();
	}
...
function GetEvalUnitNames() {
	$_return = array();
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetEvalUnitNames();
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = array();
	}
...
function AddMoreEvalUnit($objs) {
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$client->AddMoreEvalUnit($objs);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
	}
}
...
function DeleteMoreEvalUnit($obj_ids) {
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$client->DeleteMoreEvalUnit($obj_ids);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
	}
}

function GetEvalUnitByFields($fields) {
	$_return = new EvalUnit();
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetEvalUnitByFields($fields);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetEvalUnitByField1($field, $value) {
	$_return = new EvalUnit();
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
...
function GetEvalUnitByField2($field1, $value1, $field2, $value2) {
	$_return = new EvalUnit();
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetEvalUnitByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetEvalUnitListByFields($fields) {
	$_return = array();
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetEvalUnitListByFields($fields);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = array();
	}
...
function GetEvalUnitListByField1($field, $value) {
	$_return = array();
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
...
function GetEvalUnitListByField2($field1, $value1, $field2, $value2) {
	$_return = array();
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
...
function GetEvalUnitIdByFields($fields) {
	$_return = -1;
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetEvalUnitIdByFields($fields);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetEvalUnitIdByField1($field, $value) {
	$_return = -1;
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
...
function GetEvalUnitIdByField2($field1, $value1, $field2, $value2) {
	$_return = -1;
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetEvalUnitIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetEvalUnitIdListByFields($fields) {
	$_return = array();
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetEvalUnitIdListByFields($fields);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = array();
	}
...
function GetEvalUnitIdListByField1($field, $value) {
	$_return = array();
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
...
function GetEvalUnitIdListByField2($field1, $value1, $field2, $value2) {
	$_return = array();
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
...
function GetHighDrillingPoreByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetHighDrillingPoreByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetHighDrillingPoreIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetHighDrillingPoreIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetHighDrillingPoreParamByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetHighDrillingPoreParamByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetHighDrillingPoreParamIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetHighDrillingPoreParamIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetHighDrillingSiteParamByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetHighDrillingSiteParamByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetHighDrillingSiteParamIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetHighDrillingSiteParamIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetHighDrillingTunnelByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetHighDrillingTunnelByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetHighDrillingTunnelIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetHighDrillingTunnelIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetHydrGeoByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetHydrGeoByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetHydrGeoIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetHydrGeoIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetMineByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetMineByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetMineIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetMineIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetMineBaseByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetMineBaseByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetMineBaseIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetMineBaseIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetMineRegionByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetMineRegionByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetMineRegionIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetMineRegionIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetPoreFlowByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetPoreFlowByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetPoreFlowIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetPoreFlowIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetPoreSizeByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetPoreSizeByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetPoreSizeIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetPoreSizeIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetResAbundanceByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetResAbundanceByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetResAbundanceIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetResAbundanceIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetRockByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetRockByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetRockIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetRockIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetSysInfoByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetSysInfoByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetSysInfoIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetSysInfoIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetTechModeByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetTechModeByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetTechModeIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetTechModeIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetTechnologyByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetTechnologyByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetTechnologyIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetTechnologyIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetTopoGeoByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetTopoGeoByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetTopoGeoIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetTopoGeoIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetTunnelByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetTunnelByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetTunnelIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetTunnelIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetWorkAreaByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetWorkAreaByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetWorkAreaIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetWorkAreaIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
...
function GetWorkSurfByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetWorkSurfByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return->id = -1;
	}
...
function GetWorkSurfIdByField2($field1, $value1, $field2, $value2) {
	...
	try {
		$service_client = new ThriftClient('\cbm\CbmServiceClient', HOST, PORT2);
		$client = $service_client->getClient();
		$_return = $client->GetWorkSurfIdByField2(field1, value2, field2, value2);
	} catch (TException $tx) {
		print 'TException: '.$tx->getMessage()."\n";
		$_return = -1;
	}
