...
protected:
	...
	void OnMineIndexComboxSelChanged(SOUI::EventArgs *pEvt);
...
protected:
	...
	EVENT_MAP_BEGIN()
		...
		EVENT_NAME_HANDLER(_T("mine_index"), EVT_CB_SELCHANGE, OnMineIndexComboxSelChanged)
