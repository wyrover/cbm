...
class Ui_mine_gas_flow_predict_design_dlg(object):
    def setupUi(self, mine_gas_flow_predict_design_dlg):
        ...
        self.drilling_surf_qa.setGeometry(QtCore.QRect(110, 60, 71, 20))
        ...
        self.drilling_surf.setGeometry(QtCore.QRect(90, 30, 91, 22))
