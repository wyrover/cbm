...
class Ui_ws_gas_flow_predict_dlg(object):
    def setupUi(self, ws_gas_flow_predict_dlg):
        ...
        self.work_surf = QtGui.QComboBox(ws_gas_flow_predict_dlg)
        self.work_surf.setGeometry(QtCore.QRect(80, 10, 231, 22))
        ...
        self.l1 = QtGui.QLineEdit(ws_gas_flow_predict_dlg)
        self.l1.setGeometry(QtCore.QRect(90, 140, 61, 20))
