...
class Ui_difficult_eval_dlg(object):
    def setupUi(self, difficult_eval_dlg):
        ...
        self.label_2.setGeometry(QtCore.QRect(10, 120, 161, 21))
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.eval_difficult = QtGui.QComboBox(difficult_eval_dlg)
        self.eval_difficult.setGeometry(QtCore.QRect(170, 120, 131, 21))
        ...
        self.eval.setGeometry(QtCore.QRect(60, 160, 191, 41))
    ...
    def retranslateUi(self, difficult_eval_dlg):
        ...
        self.label_14.setText(_translate("difficult_eval_dlg", "<html><head/><body><p>煤层渗透率</p></body></html>", None))
