...
class Ui_mine_degin_dlg(object):
    def setupUi(self, mine_degin_dlg):
        ...
        self.drilling_surf.setEnabled(True)
        ...
        self.more_drilling_surf = QtGui.QPushButton(mine_degin_dlg)
        self.more_drilling_surf.setGeometry(QtCore.QRect(320, 320, 61, 23))
        self.more_drilling_surf.setObjectName(_fromUtf8("more_drilling_surf"))
        self.del_drilling_surf = QtGui.QPushButton(mine_degin_dlg)
        self.del_drilling_surf.setGeometry(QtCore.QRect(260, 320, 51, 23))
