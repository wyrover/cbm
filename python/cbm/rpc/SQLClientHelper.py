...
def DeleteEvalUnit(id):
	...
	try:
		service_client = RpcClient(CbmService, host=HOST, port=PORT2)
		service_client.start()
		ret = service_client.get().DeleteEvalUnit(int(id))
		service_client.close()
	except Exception, e:
		print 'client exception:',e
		ret = False
...
def GetEvalUnitById(id):
	...
	try:
		service_client = RpcClient(CbmService, host=HOST, port=PORT2)
		service_client.start()
		_return = service_client.get().GetEvalUnitById(int(id))
		service_client.close()
	except Exception, e:
		print 'client exception:',e
		_return.id = -1
...
def GetEvalUnitByForeignKey(fkey, id):
	...
	try:
		service_client = RpcClient(CbmService, host=HOST, port=PORT2)
		service_client.start()
		_return = service_client.get().GetEvalUnitByForeignKey(fkey, int(id))
		service_client.close()
	except Exception, e:
		print 'client exception:',e
		_return.id = -1
...
def GetEvalUnitIdByForeignKey(fkey, id):
	...
	try:
		service_client = RpcClient(CbmService, host=HOST, port=PORT2)
		service_client.start()
		_return = service_client.get().GetEvalUnitIdByForeignKey(fkey, int(id))
		service_client.close()
	except Exception, e:
		print 'client exception:',e
		_return = -1
...
def GetEvalUnitByField1(field, value):
	...
	try:
		service_client = RpcClient(CbmService, host=HOST, port=PORT2)
		service_client.start()
		_return = service_client.get().GetEvalUnitByField1(field, str(value))
		service_client.close()
	except Exception, e:
		print 'client exception:',e
		_return.id = -1
...
def GetEvalUnitByField2(field1, value1, field2, value2):
	...
	try:
		service_client = RpcClient(CbmService, host=HOST, port=PORT2)
		service_client.start()
		_return = service_client.get().GetEvalUnitByField2(field1, str(value1), field2, str(value2))
		service_client.close()
	except Exception, e:
		print 'client exception:',e
		_return.id = -1
...
def GetEvalUnitListByField1(field, value):
	...
	try:
		service_client = RpcClient(CbmService, host=HOST, port=PORT2)
		service_client.start()
		_return = service_client.get().GetEvalUnitListByField1(field, str(value))
		service_client.close()
	except Exception, e:
		print 'client exception:',e
		_return = []
...
def GetEvalUnitListByField2(field1, value1, field2, value2):
	...
	try:
		service_client = RpcClient(CbmService, host=HOST, port=PORT2)
		service_client.start()
		_return = service_client.get().GetEvalUnitListByField2(field1, str(value1), field2, str(value2))
		service_client.close()
	except Exception, e:
		print 'client exception:',e
		_return = []
...
def GetEvalUnitIdByField1(field, value):
	...
	try:
		service_client = RpcClient(CbmService, host=HOST, port=PORT2)
		service_client.start()
		_return = service_client.get().GetEvalUnitIdByField1(field, str(value))
		service_client.close()
	except Exception, e:
		print 'client exception:',e
		_return = -1
...
def GetEvalUnitIdByField2(field1, value1, field2, value2):
	...
	try:
		service_client = RpcClient(CbmService, host=HOST, port=PORT2)
		service_client.start()
		_return = service_client.get().GetEvalUnitIdByField2(field1, str(value1), field2, str(value2))
		service_client.close()
	except Exception, e:
		print 'client exception:',e
		_return = -1
...
def GetEvalUnitIdListByField1(field, value):
	...
	try:
		service_client = RpcClient(CbmService, host=HOST, port=PORT2)
		service_client.start()
		_return = service_client.get().GetEvalUnitIdListByField1(field, str(value))
		service_client.close()
	except Exception, e:
		print 'client exception:',e
		_return = []
...
def GetEvalUnitIdListByField2(field1, value1, field2, value2):
	...
	try:
		service_client = RpcClient(CbmService, host=HOST, port=PORT2)
		service_client.start()
		_return = service_client.get().GetEvalUnitIdListByField2(field1, str(value1), field2, str(value2))
		service_client.close()
	except Exception, e:
		print 'client exception:',e
		_return = []
	return _return
def GetEvalUnitListByForeignKey(fkey, id):
	_return = []
	try:
		service_client = RpcClient(CbmService, host=HOST, port=PORT2)
		service_client.start()
		_return = service_client.get().GetEvalUnitListByForeignKey(fkey, int(id))
		service_client.close()
	except Exception, e:
		print 'client exception:',e
		_return = []
	return _return
def GetEvalUnitIdListByForeignKey(fkey, id):
	_return = []
	try:
		service_client = RpcClient(CbmService, host=HOST, port=PORT2)
		service_client.start()
		_return = service_client.get().GetEvalUnitIdListByForeignKey(fkey, int(id))
		service_client.close()
	except Exception, e:
		print 'client exception:',e
		_return = []
